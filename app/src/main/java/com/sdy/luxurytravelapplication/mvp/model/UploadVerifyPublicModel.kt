 ...
 *    version: 1.0
 */
class UploadVerifyPublicModel : BaseModel(), UploadVerifyPublicContract.Model {
    ...
    override fun getPicTpl(type: Int): Observable<BaseResp<ArrayList<String>>> {

        return RetrofitHelper.service.getPicTpl(hashMapOf("type" to type))
    }
}