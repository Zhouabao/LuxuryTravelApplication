...
import com.sdy.luxurytravelapplication.nim.common.ui.imageview.CheckedImageButton;
...
public class EmoticonPickerView extends LinearLayout implements IEmoticonCategoryChanged {
    ...
    public void setListener(IEmoticonSelectedListener listener) {
        if (listener != null) {
            ...
            LogUtils.i("sticker", "listener is null");
        }
    }
    ...
    private void show() {
        if (listener == null) {
            LogUtils.i("sticker", "show picker view when listener is null");
        }
        if (!withSticker) {
            showEmojiView();
        } else {
