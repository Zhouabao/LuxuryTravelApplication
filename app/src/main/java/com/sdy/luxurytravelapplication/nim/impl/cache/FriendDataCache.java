package com.sdy.luxurytravelapplication.nim.impl.cache;
...
public class FriendDataCache {
    ...
    public void buildCache() {
        ...
        Log.i(UIKitLogTag.FRIEND_CACHE, "build FriendDataCache completed, friends count = " + friendAccountSet.size());
    }
