...
import com.sdy.luxurytravelapplication.nim.common.mediaplayer.audioplayer.Playable;
...
public class MsgViewHolderAudio extends MsgViewHolderBase {
    ...
    public void onItemClick() {
        if (audioControl != null) {
            ...
            audioControl.setPlayNext(!NimUIKitImpl.getOptions().disableAutoPlayNextAudio, getAdapter(), message);
        }
    }

    private void layoutByDirection() {
        if (isReceivedMessage()) {
            setFrameGravity(animationView, Gravity.LEFT | Gravity.CENTER_VERTICAL);
...
//            containerView.setBackgroundResource(NimUIKitImpl.getOptions().messageLeftBackground);
            ...
            setFrameGravity(animationView, Gravity.RIGHT | Gravity.CENTER_VERTICAL);
            setFrameGravity(durationLabel, Gravity.LEFT | Gravity.CENTER_VERTICAL);
            unreadIndicator.setVisibility(View.GONE);
