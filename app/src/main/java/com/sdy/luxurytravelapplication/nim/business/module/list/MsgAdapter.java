package com.sdy.luxurytravelapplication.nim.business.module.list;
...
//            notifyDataSetChanged(); // 可以不要！！！
    ...
    public interface ViewHolderEventListener {
        ...
        // 发送失败或者多媒体文件下载失败指示按钮点击响应处理
        void onTipBtnClick(IMMessage resendMessage);
    ...
    public static class BaseViewHolderEventListener implements ViewHolderEventListener{
        ...
        @Override
        public void onTipBtnClick(IMMessage resendMessage) {
