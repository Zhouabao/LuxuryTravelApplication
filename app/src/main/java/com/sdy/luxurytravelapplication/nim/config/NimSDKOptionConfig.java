package com.sdy.luxurytravelapplication.nim.config;
...
import com.sdy.luxurytravelapplication.nim.api.wrapper.NimUserInfoProvider;
import com.sdy.luxurytravelapplication.nim.business.session.viewholder.MsgViewHolderThumbBase;
...
public class NimSDKOptionConfig {
  ...
  public   static String getAppCacheDir(Context context) {
    ...
    private static StatusBarNotificationConfig loadStatusBarNotificationConfig() {
        ...
        config.notificationSmallIconId = R.drawable.icon_default_avator;
        config.notificationColor = DemoCache.getContext().getResources().getColor(R.color.colorAccent);
        // 通知铃声的uri字符串
