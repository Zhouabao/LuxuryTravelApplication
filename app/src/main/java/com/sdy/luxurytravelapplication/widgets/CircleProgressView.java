...
public class CircleProgressView extends View {
    ...
    private float maxProgressSize = 30 * millisecond;//总进度是10s
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray typeArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.CircleProgressView, 0, 0);
        radius = typeArray.getDimension(R.styleable.CircleProgressView_cp_radius, 80);
        strokeWidth = typeArray.getDimension(R.styleable.CircleProgressView_strokeCWidth, 10);
        ringColor = typeArray.getColor(R.styleable.CircleProgressView_ringColor, 0xFF0000);
