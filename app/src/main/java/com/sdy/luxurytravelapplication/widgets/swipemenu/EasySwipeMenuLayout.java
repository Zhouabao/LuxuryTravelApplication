package com.sdy.luxurytravelapplication.widgets.swipemenu;
...
import static com.sdy.luxurytravelapplication.widgets.swipemenu.State.CLOSE;
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                } else if (attr == R.styleable.EasySwipeMenuLayout_swipeContentView) {
                    mContentViewResID = typedArray.getResourceId(R.styleable.EasySwipeMenuLayout_swipeContentView, -1);
