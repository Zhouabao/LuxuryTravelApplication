...
public class CollectionSuccessActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.baidu.idl.face.platform.ui.R.layout.activity_collect_success);
        initView();
        initData();
    }

    private void initView() {
        mCircleHead = (CircleImageView) findViewById(com.baidu.idl.face.platform.ui.R.id.circle_head);
        mImageCircle = (ImageView) findViewById(com.baidu.idl.face.platform.ui.R.id.image_circle);
        mImageStar = (ImageView) findViewById(com.baidu.idl.face.platform.ui.R.id.image_star);
    }
