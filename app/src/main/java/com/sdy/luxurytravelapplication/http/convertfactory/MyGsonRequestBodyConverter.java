 ...
 */
package com.sdy.luxurytravelapplication.http.convertfactory;
...
//            if (basePrams["_signature"] != null)
//            basePrams.remove("_signature")
//        basePrams.putAll(getBaseParams())
//        var sign = "${AppUtils.getAppVersionName()}dcyfyf"
//        var params1 = basePrams
//        for (param in basePrams.toSortedMap()) {
